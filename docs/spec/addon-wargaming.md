# Lonelog: Solo Wargaming Add-on
**Notation for Units, Battles, and Campaigns**
CC BY SA
Version 1.0.0

## Table of contents
* Solo Wargaming Add-on | 1
* Overview | 1
* Part I: Practical Reference | 5
* 1. Battle Structure | 9
* 2. Unit Tracking | 13
* 3. Scenario Setup | 18
* 4. Campaign Tracking | 20
* 5. Vehicles and Mechs | 24
* Cross-Add-on Interactions | 28
* System Adaptations | 31
* Best Practices | 41
* Quick Reference | 46
* FAQ | 50
* Credits & License | 52
...
| Addition | Example in a log | Purpose |
| :--- | :--- | :--- |
| `[Unit:Name\|size\|stats\|status]` | `[Unit: Ironclad Rifles\|x12\|Morale 8\|Fresh]` | Track a military unit's state through a battle |
| `[Force: Name\|commander\|strength\|objective]` | `[Force: Reiklanders\|Captain Streng\|3 units\|Raid]` | Optional: record overall force composition and goal |
| `[BATTLE] / [/BATTLE]` | `[BATTLE]`<br>`...`<br>`[/BATTLE]` | Delimit a wargame battle within a session |
| `Tn#` turn markers | `Tn1, Tn2, Tn3` | Separate unit-scale game turns within a battle |
| Location armor fields | `[Unit:Atlas\|Armor CT22/RT18/LT18]` | Track mech/vehicle armor by hit location |
| `[CAMPAIGN] / [/CAMPAIGN]` | `[CAMPAIGN]`<br>`...`<br>`[/CAMPAIGN]` | Record warband or force state between sessions |
...
[Unit:Cavalry|x6|Morale 7|Fresh]
[Unit:Artillery|x4| Morale 6|Fresh]
[/CAMPAIGN]

### S1 *Broken bridge, dawn*
[BATTLE]
[Scenario: Hold the Line | Deny bridge 6 turns | Turn limit 8]
[Unit: Raider Infantry | x15 | Morale 6 | Fresh | road approach]
[Unit: Raider Skirmishers|x8|Morale 5|Fresh| left flank]

Tn1
@(Raider Skirmishers) Advance through woods
@(Rifles) Hold position, volley fire
d: Shooting 2d6=9 vs TN 7 -> Hit
=> [Unit: Raider Skirmishers|x6|wavering]

Tn2
d: Morale 2d6=11 vs Morale 5 -> Broken
=> [Unit: Raider Skirmishers|x6|broken | fleeing]
[/BATTLE]

=> Bridge held. Raiders withdrew after two turns.

[CAMPAIGN]
[Unit:Rifles|x11 | Morale 8| Fresh] (one casualty)
[/CAMPAIGN]
```
...
> `[Unit:Warband|x8|Morale 6|Fresh]`
> `[Unit: Defenders | x6 | Morale 7|Fresh]`
...
> `[Unit: Swordsmen|x3| Morale 7 | Fresh| deployment zone A]`
> `[Unit:Marksmen|x2| Morale 7 | Fresh|deployment zone A]`
> `[N:Captain Streng|WS4|Ld8|sword+pistol|Fresh]`
> `[Unit: Skaven Night Runners|x6|Morale 5|Fresh| deployment zone B]`
> `[Unit:Skaven Clanrats|x4| Morale 4 | Fresh | deployment zone B]`
...
> `=> [Unit: Raiders | x13 | Morale 6|Steady]`
> `@(Raiders) Return fire`
...
* **size** - model count xN, or abstract: full, half, depleted
...
Examples:
> `[Unit:Ironclad Rifles | x12 | Morale 8 | Fresh]`
> `[Unit:Skeleton Warriors |x8 | Morale 4 | Fresh|at bridge]`
> `[Unit:Cavalry Screen|x6|Morale 7 | at ridge| Engaged]`
> `[Unit:Artillery Battery | x4 | Morale 6| rear | Pinned]`
...
> `[Unit:Rifles | x12 | Morale 8| Fresh]` (opening state)
> `d: Enemy volley 2d6=8 vs TN 7 -> Hit`
> `=> [Unit:Rifles | x10|Morale 8| Steady]` (two casualties)

For significant losses that affect morale:
> `=> [Unit:Rifles|x8|wavering]`
> `d: Morale 2d6=9 vs Morale 8 -> Steady`
> `=> [Unit:Rifles|x8|Steady]`
...
> `[Unit:Pikes|x16 | Morale 7 | Line|Fresh]`
> `[Unit:Muskets | x12 | Morale 6 | Column | Marching]`
> `@Form square against cavalry`
> `=> [Unit:Muskets | x12 | Morale 6 | Square|Fresh]`
...
> `[Unit:Swordsmen|x3| Exp 0|Fresh]`
> `[Unit: Marksmen|x2| Exp 2 | Marksman skill]`
> `[Wealth:Gold 50gc]`
> `[/CAMPAIGN]`
...
Hired swords and specialists use `[Unit:]` with a count of x1:
> `[Unit:Dwarf Troll Slayer |x1| Exp 3 | Fearless| Fresh]`
...
> `=> [Unit:Summoner | Armor CT22->8/RT18/LT18| Heat | Steady]`

Or if internal structure is breached:
> `d: PPC 2 fires at Kit Fox CT+LT, 2x10=20 damage -> CT destroyed`
...
| Situation | Add-on | Use |
| :--- | :--- | :--- |
| Unit activation, morale, casualties | Wargaming | (`Tn#`, `[Unit:]`) |
| Named hero's personal duel | Combat | (`Rd#`, `[F:]`) |

Combined example - Mordheim duel within a battle:
> `[BATTLE]`
> `[Scenario:Wyrdstone Hunt | Collect 3 shards | 6 turns]`
> `[Unit: Swordsmen|x3| Morale 7 | Fresh]`
> `[N: Captain Streng|WS4|Ld8|sword+pistol|Fresh]`
> `[Unit:Skaven Night Runners|x6|Morale 5|Fresh]`
> `[N:Skaven Assassin | WS5|hidden]`
> `Tn1`
> `@Advance Swordsmen to center ruins`
> `@(Night Runners) Move toward objective marker`
> `Tn2`
> `@(Skaven Assassin) Reveals and charges Streng`
...
> `=> [Unit:Night Runners|x4|wavering]`
...
> `[Unit:Warband|x6|Morale 6|Fresh|R:1]`
> `Tn1`
...
| Henchman group | `[Unit:Name\|xN\| Exp N\|status]` |
...
[Unit:Swordsmen|x3| Exp 0|Fresh]
[Unit:Marksmen|x2| Exp 2 | Marksman skill|Fresh]
[Unit:Dwarf Slayer |x1| Exp 3 | Fearless | Fresh]
[Wealth: Gold 57gc]
[/CAMPAIGN]
...
[Unit:Night Runners|x6|Morale 5 | Fresh|east deployment]
[Unit:Clanrats|x4|Morale 4|Fresh|east deployment]
...
=> [Unit:Night Runners|x6|at rubble]

Tn2
@Marksmen fire on Night Runners
d: Shooting BS3 2d6=7 vs TN 7 -> Hit
=> [Unit:Night Runners|x5| Morale 5 | Steady]
...
=> [Unit:Night Runners|x3|wavering]
d: Morale 1d6=5 vs Ld 5 -> Broken
=> [Unit:Night Runners|x3|broken|fleeing]

Tn4-6
@ Collect remaining shards, hold position
d: Search x2 1d6=4, 1d6=6 -> 1 more shard found
...
[Unit: Swordsmen|x3| Exp 1|+1 to hit]
...
[Unit:Kit Fox A x3| Pilot: assorted (G3/P3)| Armor CT10/RT8/LT8/RA6/LA6/RL12/LL12|Heat 0| Fresh]

Tn1 Move:
d: Initiative 2d6=9 vs 2d6=6 -> Alpha Lance moves second (advantage)
@(Summoner) Advance north through rubble
@(Kit Fox x3) Fan out, east flank screening formation
...
=> [Unit:Summoner | Armor CT22->2/RT18/LT18| Heat | Steady]
...
[Unit:Infantryman|x2|Exp 0|Fresh]
[Unit:Thug|x2|Exp 0|Fresh]
[Wealth: Gold 200gc]
[/CAMPAIGN]
...
[Unit: Rival Warband|x6|Morale 6| Fresh|north edge]
...
=> [Unit:Rival Infantryman x1 | stunned]
...
`=> [Unit:Raiders | x10|wavering]`
`d: Morale 2d6=9 vs Morale 6 -> Broken`
`=> [Unit: Raiders | x10|broken|fleeing]`

**Don't: Track individual model hit points in a unit tag**
X `[Unit: Raiders | Model1: HP3, Model2: HP2, Model3: HP1, Model4: HP3...]`

✓ `[Unit: Raiders|x4|half strength | Steady]`

**Do: Use the Combat Add-on for personal-scale duels within a battle**
✓ `Tn3`
`- Captain breaks away to duel the enemy champion`
`[COMBAT]`
...
| Tag | Purpose | Example |
| :--- | :--- | :--- |
| `[Unit: Name\|size\|stats\|status]` | Military unit state | `[Unit:Rifles\| x12\|Morale 8\|Fresh]` |
...
### Structural Blocks
| Block | Opens when | Closes when | Analog equivalents: |
| :--- | :--- | :--- | :--- |
| `[BATTLE]` | Battle begins | Scenario resolves | `--- BATTLE ---` / `--- END BATTLE ---` |
| `[CAMPAIGN]` | At session start or end | After state is recorded | `--- CAMPAIGN ---` / `--- END CAMPAIGN ---` |
...
> `[Unit:Cultists|x6|Morale 5|Fresh]`
...
> `=> [Unit:Cultists|x4|wavering]`
> `d: Morale 1d6=6 vs Ld 5 -> Broken`
> `=> [Unit:Cultists|x4|broken|fleeing]`
> `[/BATTLE]`
...
A: No. Status fields are optional. If your system doesn't track morale or unit condition, simply omit those fields from `[Unit:]` tags. `[Unit: Rifles | x12 | Fresh]` is perfectly valid notation.
...
This add-on extends Lonelog by Roberto Bisceglie.
