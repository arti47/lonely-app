# Lonelog: Card Notation Add-on
**A Standard Notation for Playing Cards in Session Logs**
Version 1.0.0
CC BY SA

## Table of contents
* Overview | 1
* What This Add-on Adds | 2
* Design Principles | 2
* Part I: Practical Reference | 4
* How card draws fit into a log entry | 4
* Standard Playing Cards | 6
* Tarot | 7
* Oracle Decks | 9
* Spreads | 10
* Common Patterns by System | 11
* Part II: Complete Reference | 13
* 1. Standard Deck Notation | 14
* 2. Tarot Notation | 15
* 3. Oracle Decks | 18
* 4. Spread Notation | 19
* Quick Reference | 21
* FAQ | 23
* Credits & License | 25
...
| `r` suffix | Reversed orientation | `d: draw=M16r` |
| Position labels in spreads (Tarot) | Named positions in a multi-card spread | `d: Past=5s, Present=Ks` |
...
| :--- | :--- | :--- | :--- |
| `Ah` | Ace of Hearts | `10d` | Ten of Diamonds |
| `7c` | Seven of Clubs | `Jh` | Jack of Hearts |
| `Ks` | King of Spades | | |
...
| Code | Meaning | Code | Meaning |
| :--- | :--- | :--- | :--- |
| `Ah` | Ace of Hearts | `Jh` | Jack of Hearts |
| `2c` | Two of Clubs | `Qs` | Queen of Spades |
| `10d` | Ten of Diamonds | `Kd` | King of Diamonds |
| `Jkr` | Joker | | |
...
#### Major Arcana
Format: `M{n}` where n is 0-21. Reversed: append r M0r, M16r.
...
* `? Is this the right path?`
  `d: draw=M17 -> Yes` | question answered by card oracle

---

## FAQ
* **Q: Why does the card use `=` rather than `->` - isn't the card itself the outcome?**
  A: The card drawn is the raw result of the mechanic, just as 9 is the raw result of 2d6+2. What the card means in context is the interpreted state the outcome, and that goes in `->`. `d: draw=Qs -> Dark omen` mirrors `d: Strike 2d6+2=9 -> Hit` exactly.
...
* **Q: Tarot decks vary some have different names or art. Does M12 always mean The Hanged Man?**
  A: This spec follows the Rider-Waite-Smith numbering, which is the most common standard. If your deck diverges (e.g. Thoth swaps Strength and Justice), note it once in your session header: `[Deck: Thoth Justice=M8, Strength=M11]`.
