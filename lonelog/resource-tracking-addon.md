# Lonelog: Resource Tracking Add-on
**Inventory, Supplies, and Wealth Notation**
CC BY SA
Version 1.1.0

## Table of contents
* Resource Tracking Add-on | 1
* Overview | 1
* 1. The Inventory Tag | 4
* 2. Abstract Supply Tracking | 10
* 3. Wealth and Currency | 13
* 4. Resource Events | 16
* 5. The Resource Status Block | 19
* Cross-Add-on Interactions | 21
...
| Supply notation inside `[PC:]` | Abstract resource levels | `[PC:Kael\|Supply d8]` |
...
> `[Inv: Torch|6] [Inv: Rope|2|50ft each]`
> `[Inv: Rations|10|days]`
...
Some games track bundles rather than individual items. Use the `x` multiplier or descriptive grouping:
* `[Inv: Arrow x 20]` (bundle notation)
* `[Inv: Adventuring Kit|1|contains: rope, pitons, torch x2, rationsx3]`
* `[Inv:Quiver|1|Arrowx15]` (container with contents)

For slot-based inventory systems:
* `[Inv: Slot 1 | Short Sword]`
* `[Inv: Slot 2| Shield | cracked]`
* `[Inv:Slot 3 | Torch x 3]`
* `[Inv:Slot 4 | empty]`
...
> `-> No, but...`
> `=> A dry streambed - if I follow it, maybe tomorrow. [Timer: Dehydration 2]`
...
> `=> I find a path through. Torch is getting low. [Inv:Torch|2->1] [Timer: Torchlight 3]`
...
...
Torch x2, Rations x3 days
Rope 50ft (frayed), Healing Potion x1
Arrow x 9, Bone Amulet (Ward of the Dead)
--- END RESOURCES ---
```
...
When to use it:
...
| :--- | :--- | :--- |
| Dungeon exploration with supply pressure | Dungeon Crawling + Resource Tracking | `[Inv:]`, `[R:]`, `[Timer:]` |
...
| Full dungeon crawl with fights | All three add-ons | `[COMBAT]`, `[R:]`, `[Inv:]`, `[Wealth:]` |
...
> `[COMBAT]`
> `[F:Skeletonx3|HP 3 each | Close]`
> `Rd1`
> `@Fire at the nearest skeleton`
> `d: Ranged d6=5 vs TN 4 -> Success`
> `=> Arrow shatters its skull! [F:Skeletonx3->2] [Inv:Arrow-1]`
...
> `=> The crypt goes quiet. [F: Skeletonx0]`
> `[/COMBAT]`
> `@Search the room`
...
> `[Inv:Slot 2|Shield]`
> `[Inv:Slot 3|Torchx3]`
> `[Inv:Slot 4 | Rationsx4]`
> `[Inv: Slot 5 | Rope 50ft]`
> `[Inv:Slot 6-10|empty]`
> `(note: 10 slots max, STR-based encumbrance)`

> `@Pick up the golden idol`
> `=> [Inv:Slot 6 | Golden Idol|heavy | occupies 2 slots] [Inv:Slot 7 | occupied]`
...
X `(I subtracted 3 arrows but didn't write it down anywhere)`

✓ Show the change, even briefly:
`[Inv: Arrow-3]`
...
X `[Inv: Bootlaces |2|leather]` (unless your game literally tracks this)
...
X `[PC:Kael | HP 12 | Torch 3 | Arrow 9 | Rations 5]` (inventory list inside a character stat tag)
...
| Purpose | Tag | Example |
| :--- | :--- | :--- |
| Concrete inventory item | `[Inv:Item\|qty\|props]` | `[Inv:Torch\|3]` |
| Reference previously established item | `[#Inv: Item]` | `[#Inv: Bone Amulet]` |
| Quantity change (gain/lose) | `[Inv:Item+N]` / `[Inv:Item-N]` | `[Inv:Arrow-1]` |
| Explicit quantity transition | `[Inv: Item\| qty -> qty]` | `[Inv:Torch\|3->2]` |
| Item fully consumed or gone | `[Inv:Item\|depleted]` | `[Inv:Oil Flask\|depleted]` |
| Concrete currency total | `[Wealth:Cur N]` | `[Wealth: Gold 45]` |
| Currency earned | `[Wealth:Cur+N]` | `[Wealth:Gold+15]` |
| Currency spent | `[Wealth:Cur-N]` | `[Wealth: Gold-8]` |
...
A: Either nest descriptively - `[Inv: Bag of Holding| contains: Wand, Scrolls x 3, Gold 100]` - or track the container and contents separately. For slot-based systems, just mark which slots are "in the bag." Don't over-engineer it.
